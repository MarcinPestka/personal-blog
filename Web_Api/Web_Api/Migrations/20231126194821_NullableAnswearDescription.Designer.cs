...
namespace Web_Api.Migrations
{
    ...
    [Migration("20231126194821_NullableAnswearDescription")]
    partial class NullableAnswearDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Api.Model.Answear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("AnswearText")
                        .IsRequired()
            ...
            modelBuilder.Entity("Web_Api.Model.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Api.Model.LastTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Api.Model.Post.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Api.Model.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("CorrectAnswearId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Api.Model.Answear", b =>
                {
                    b.HasOne("Web_Api.Model.Question", "Question")
                        .WithMany("Answears")
            ...
            modelBuilder.Entity("Web_Api.Model.Exam", b =>
                {
                    b.HasOne("Web_Api.Model.Lecture", "Lecture")
                        .WithOne("Exam")
                        .HasForeignKey("Web_Api.Model.Exam", "LectureId");
            ...
            modelBuilder.Entity("Web_Api.Model.Question", b =>
                {
                    b.HasOne("Web_Api.Model.Exam", "Exam")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Web_Api.Model.Section", b =>
                {
                    b.HasOne("Web_Api.Model.Post.Post", null)
                        .WithMany("Sections")
